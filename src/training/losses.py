...
class BinaryClassificationLoss(nn.Module):
    ...
    Args:
        ...
        label_smoothing (float): smooths hard 0/1 labels to reduce overconfidence (0 = none, 0.1 = slight)
    """
...
if __name__ == "__main__":
    loss_fn = BinaryClassificationLoss(pos_weight=cfg.POS_WEIGHT, label_smoothing=0.1)
