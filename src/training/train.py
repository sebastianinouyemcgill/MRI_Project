...
def train():
    ...
    train_dataset = MRIDataset(cfg.COLAB_ROOT, LABEL_JSON, seq_len=cfg.SEQ_LEN, split=TRAIN_SPLIT, train=True)
    val_dataset   = MRIDataset(cfg.COLAB_ROOT, LABEL_JSON, seq_len=cfg.SEQ_LEN, split=VAL_SPLIT, train=False)
